...
png(filename="figures/FigureS7.png", width=1200, height=650)
...
# overall PCA space - by clade PC1 x PC2 [Figure 2]
...
g_pca1<-ggarrange(g_pca_clade1, g_pca_rmin1,
                  ...
                  labels=c("(a)", "(b)"));g_pca1
# save Figure 2
ggsave(g_pca1,file='figures/Fig2.png',width=18,height=32, units = "cm", dpi = 300)


# overall PCA space - by clade PC1 x PC3 ----------------
...
# save Figure S8
ggsave(g_pca_all,file='figures/FigS8.png',width=32,height=32, units = "cm", dpi = 300)
# END